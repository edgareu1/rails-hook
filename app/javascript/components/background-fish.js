// Function that creates the background animation of the home page (using the
// canvas element)
  ...
  var Fish = function (id) {
    ...
    Fish.prototype.calc = function () {
      ...
      if (
        ...
        for (var i = 0; i < fishes.length; i++) {
          ...
          if (fish != this) {
            ...
            // Is it closer, within the max distance and within the sector that
            // the fish can see?
            if (
      ...
      if (this.following != null) {
        ...
        if (
          // On colliding angle?
          this.angleDirectionDifference() > Math.PI * 0.9 &&
          ...
          this.dx +=
            Math.cos(this.angleToClosestFish()) * (0.05 * this.distanceFactor);
          this.dy +=
            Math.sin(this.angleToClosestFish()) * (0.05 * this.distanceFactor);
        }
      ...
      // Recreate speed vector from recombining angle of direction with
      // normalized speed
