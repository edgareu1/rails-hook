...
Fish.create(common_name: 'Horse Mackerel', good_weight: 450, scientific_name: 'Trachurus trachurus', legal_weight: 0, legal_size: 15, picture_url: "https://res.cloudinary.com/tomfishson/image/upload/v1593591265/HOOK/horsemackerel_rnfugs.png", description: 'It inhabits the water column in the coastal areas, from the surface to the bottom, between 0 to 200 m of depth. Horse mackerels form large schools that migrate for long distances, feeding on small crustaceans, fish and molluscs. It spawns from December to April.', url: 'https://en.wikipedia.org/wiki/Atlantic_horse_mackerel')

Fish.create(common_name: 'Chub Mackerel', good_weight: 500, scientific_name: 'Scomber colias', legal_weight: 0, legal_size: 20, picture_url: "https://res.cloudinary.com/tomfishson/image/upload/v1593591264/HOOK/chubmacker_u7a9fd.png", description: 'Inhabits the water column of the coastal areas down to 250 m depth. Chub Mackerels form large schools that are strongly migratory, remaining close to the bottom during the day and moving upwards at night to hunt for fish, molluscs and small crustaceans. It spawns from February to April, when the female releases 100,000 to 400,000 eggs.', url: 'https://en.wikipedia.org/wiki/Mackerel')
...
Fish.create(common_name: 'Swordfish', good_weight: 100000, scientific_name: 'Xiphias gladius', legal_weight: 25000, legal_size: 125, picture_url: "https://res.cloudinary.com/tomfishson/image/upload/v1593591264/HOOK/swordfish_dme4os.png", description: 'The Swordfish has a wide body without scales, a bluish black back and lighter belly with an elongated snout forming a characteristic flattened sword that it uses to divide the schools and to defend itself. It inhabits the water column down to 800 m of depth. It is a solitary fish, highly migratory, very voracious and aggressive, ingesting their prey in one piece. It spawns from January to October.', url: 'https://en.wikipedia.org/wiki/Swordfish')
...
Fish.create(common_name: 'Spotted Seabass', good_weight: 1000, scientific_name: 'Dicentrarchus punctatus', legal_weight: 0, legal_size: 20, picture_url: "https://res.cloudinary.com/tomfishson/image/upload/v1594141192/HOOK/baila_mnvy5r.png", description: 'The Spotted Seabass has an elongated silver-grey body with small black spots. It inhabits coastal waters ranging in  depth from 0  - 30  meters.', url: 'https://en.wikipedia.org/wiki/Spotted_seabass')
